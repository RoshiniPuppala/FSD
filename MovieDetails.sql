/*creating and inserting data into  Movies table*/
CREATE TABLE Movies(movieId int(10) PRIMARY KEY, title varchar(20), release_year varchar(20), director_Id int(10));
INSERT INTO Movies VALUES (101, "Bahubali", '2015', 1101),(102, "Mirchi", '2013', 1102),(103, "Rebel", '2012', 1103),(104, "Billa", '2009', 1104);

/*creating and inserting data into Directors table*/
...
/*creating and inserting data into Genres table*/
...
/*creating and inserting data into Movie_Genres*/
CREATE TABLE Movie_Genres (movie_Id int(10) PRIMARY KEY, genre_Id int(10));
INSERT INTO Movie_Genres VALUES (101, 191),(102, 192),(103, 193);
